      ...
      <div className="">
            ...
            <div className="p-4 flex flex-col justify-between w-full">
              ...
              <ul className="mt-4 flex flex-col space-y-4 transition-all duration-300 ease-in-out">
                <li className="relative">
                  <Link id='projects' to="/project" className="text-white text-[32px] flex items-center space-x-2 group">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="bg-white [box-shadow:0px]">
            <div className="lg:px-8 px-3 py-3">
              <div className="flex lg:flex-row reverse justify-between items-center">
                <button
                ...
                <div className='lg:pl-16' onMouseEnter={handleMouseEnterContact} onMouseLeave={handleMouseLeaveContact}>
                  <Link to={'/'}>
                  <img  id='logo' src= {NewLogo} alt="" /></Link>
                </div>
                <Link className='hide' to={'/contact'}>
