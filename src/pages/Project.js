    ...
    <div className={`page ${isVisible ? 'slide-in' : ''}`}>
      ...
      <div className='blur-section'>
        <div className='px-8 py-10 '>
          ...
          <p className="text-[#141414] text-[36px] sm:text-[48px] md:text-[56px] lg:text-[74px] font-bold flex gap-5 overflow-hidden "><p ref={cus2Ref}>Design</p><p ref={cus3Ref}> Kits</p><p ref={cus4Ref}>for</p> <p ref={cus5Ref}>Creative</p></p>
          <p className="text-[#141414] text-[36px] sm:text-[48px] md:text-[56px] lg:text-[74px] font-bold flex gap-5 overflow-hidden "><p ref={cus6Ref}>Designers</p></p>
